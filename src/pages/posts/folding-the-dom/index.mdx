...
Most transform properties can specify an axis. In our case, we want to rotate
it around its x axis, but check out what the other axes do as well:
  ...
  {({ axis, degrees }) => (
    ...
    >
      {interpolated => {
        ...
        //
        return <div style={{ perspective: 500 }}>
          <div
            style={{
              paddingBottom: 30,
            }}
          ...
          >
            Photo by <TextLink href="https://unsplash.com/photos/mlOPryU1p_U">Annie Spratt</TextLink>.
          </div>
        </div>;
      }}
    </Spring>
