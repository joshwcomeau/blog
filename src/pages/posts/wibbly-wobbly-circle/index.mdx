...
Regardless of how you feel about Material Design, there's a really cool idea here: our websites and apps can be thought of as a _universe_, with its own set of physics, and we get to decide how elements in that universe behave.
...
Try dragging one of the control points, the smaller outlined circles. And try dragging one of the larger solid ones. Two things should become apparent:

- With the right manipulation, we could achieve something pretty gelatinous!
- It's very easy to get accidental 'cricks' in the circle, sharp corners and weird deformations, like this:

import notAllowedSrc from './not-allowed.png';

<img src={notAllowedSrc} hideBorder alt="The handles are manipulated so that it forms a sort of infinity-loop, an '8'. This is not how a gelatinous ball should behave!" style={{ maxWidth: 400, margin: 'auto' }}  />

I wanted our gelatinous balls to behave correctly: no cricks, creases, cracks, crannies, or crevices. Thankfully, trigonometry is our friend here!
