...
> _Note:_ If you're a junior developer interested in remote work, this will be an even steeper climb for you :( I believe that remote work is a perfectly valid option for folks of all skill levels, but the common perception is that it's harder for juniors to find adequate mentorship in a remote context.
>
> My personal opinion, therefore, is that you'll have more luck looking for an in-office job, but you can start taking steps now to make it easier for yourself to find remote work in the future. Keep reading!
...
> This system is not super fair. It's problematic that contributing to open-source can be a "ticket" into remote work, since not everyone has the privilege to spend their nights/weekends hacking on side-projects. The sad reality, though, is that any sort of job hunt will require time outside of working hours. I don't know of any way around that, and I think this is maybe the best way to spend that time.
