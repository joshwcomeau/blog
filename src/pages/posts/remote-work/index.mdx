...
I had an interesting realization recently: I was three years into my career when I got my first remote job, and it's been about three years since then. In other words, I've split my time equally between traditional in-office work and remote work!

Increasingly, remote work is becoming a common, mainstream thing. Twitter pundits have been quick to form and share opinions, and I've seen a lot of misinformation around what remote work is, and how it works.

This is part 1 of a three-part blog post series. Today, I'll explore what my experience has been like - it'll be an honest look at the ups and downs of remote life. The goal is to help give folks the context they need to understand if remote work is something they should consider for themselves.
...
This schedule is not universal to remote workers, and that's kind of the point - the idea with remote work is that it's flexible, it allows you to construct whatever working situation works best for you. Plenty of remote workers _do_ work from home (though none that I've met have been the unshaven recluse so often depicted in remote-work discussions), but they do it because that's the situation that works best _for them_.

# Developing my working environment

Here's what I know about myself: I'm an introvert who requires frequent but brief social interactions. I'm a creature of habit, and find comfort in routine. I get restless when I spend too long in the same environment. I need a quiet, distraction-free place to work - I'm finicky, and have a very low tolerance for noise.

In a previous life, I worked from my home as an independent web developer / contractor, and I didn't like it. It's never a good sign when you start looking forward to doing groceries, because it's a reason to leave the house.

When I started working remotely for Khan Academy, I rented an office at WeWork. It ticked a bunch of boxes, but ultimately it wasn't a perfect fit. It was rowdy at times. It was also kinda dreary - they keep their lights dim, so it always feels like 7pm. The office I was renting was small enough that if I stood in the center, I could just about touch all 4 walls without moving. It was kinda claustrophobic.
...
I live in Montréal, Québec. According to [Payscale](https://www.payscale.com/research/CA/Job=Software_Developer/Salary/d8efee6e/Montr%C3%A9al-QC), the average software developer here makes about $65,000 CAD, about $49,000 USD. This is dramatically less than in the Bay Area, where [Payscale](https://www.payscale.com/research/US/Job=Software_Engineer/Salary/a5e48575/San-Francisco-CA) estimates the average salary at ~\$118,000 USD. That's a **2.4x multiple**!
