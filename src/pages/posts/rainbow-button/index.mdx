...
Before you start shipping rainbows, there are a couple things we need to think about / fix.
...
>
> Color-shifting isn't _quite_ the same thing as "motion", but with side-effects like those, I'd rather play it safe.
